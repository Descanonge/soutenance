...
\begingroup
\newcommand\graph[2]{%
  \llap{\includegraphics<#2>[height=0.88\textheight]{results/_fronts_occurrence/#1<#2>.pdf}}}%
\begin{frame}
  \frametitle{Cartes de probabilité de présence des fronts}
  \includegraphics[height=0.88\textheight]{results/_fronts_occurrence/base<1->.pdf}%
