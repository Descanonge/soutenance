...
\begin{frame}
  ...
  \includegraphics[
  height=0.85\textheight, trim=0 0 0 120, clip
  ]{levy_2023_fig1/transparent/base<1->.pdf}%
  \graph{export}{2-}%
  \graph{cycle}{3-}%
  \graph{fronts}{4-}%
  % \graph{sat}{5-}%
...
\begin{frame}
  ...
  \includegraphics[width=0.8\textwidth]{front_exemple/front_exemple.pdf}
  \\
...
\NewDocumentCommand\graph{O{#3} m m}{%
    ...
    ]{levy_2023_fig1/transparent/#2<#3>.pdf}}}%
\begin{frame}
  \frametitle{Approche: synopticité de l'imagerie satellitaire}

  \begin{columns}
    \begin{column}{0.55\textwidth}
      \includegraphics[height=0.82\textheight]{levy_2023_fig1/transparent/base<1->.pdf}%
      \graph[1-]{export}{2-}%
      \graph[1-]{cycle}{3-}%
      \graph[1-]{fronts}{4-}%
      \graph[1-]{sat}{5-}%
...
\begingroup
\newcommand\graph[2]{%
  \llap{\includegraphics<#2>[height=0.75\textheight]{front_circulation/transparent/#1<#2>.pdf}}}%
...
\begin{frame}
  ...
  \end{itemize}
  \begin{block}{}
    \includegraphics[width=0.65\textwidth]{whitt_2019/whitt_2019.pdf}
...
\begingroup
\newcommand\graph[2]{%
  \llap{\includegraphics<#2>[height=0.75\textheight]{front_circulation/transparent/#1.pdf}}}%
\begin{frame}
  \frametitle{Impact des fronts sur la croissance du phytoplancton}
    \includegraphics[height=0.75\textheight]{front_circulation/transparent/base<1->.pdf}%
    \graph{upwell<6->}{2-}%
    \graph{isopycnals<1->}{1-}%
    \graph{jet<2->}{1-}%
    \graph{vorticity<3->}{1-}%
    \graph{mld<5->}{1-}%
    \graph{circulation<4->}{1-}%
\end{frame}
\endgroup
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{0.33\linewidth}
      \includegraphics[width=\linewidth]{levy_2023_fig3/levy_2023_fig3.pdf}
    \end{column}
  \end{columns}
...
\newcommand\graph[2]{%
    ...
    ]{région_étude/transparent/#1<#2>.pdf}}}%
\begin{frame}
  \frametitle{Région d'étude: autour du Gulf Stream}
  \includegraphics[
  width=\textwidth, height=\textheight, keepaspectratio
  ]{région_étude/transparent/base_chl<1->.pdf}%
  \graph{base_sst}{1-7}%
...
\begin{frame}
  ...
  \begin{columns}[t]
    \begin{column}{0.45\textwidth}
      ...
      \begin{center}
        \includegraphics[width=0.7\linewidth]{nieto_2012/nieto_2012.pdf}
    ...
    \begin{column}{0.55\textwidth}
      ...
      \begin{center}
        \includegraphics[width=\linewidth]{front_exemple/front_exemple_zone.pdf}
...
\newcommand\graphstep[2]{%
  \llap{\includegraphics<#2>[width=\textwidth]{composantes/transparent/#1<#2>.pdf}}}%
\begin{frame}
  ...
  \includegraphics[width=\textwidth]{composantes/transparent/base<1->.pdf}%
...
\begingroup
\newcommand\graph[2]{%
  \llap{\includegraphics<#2>[height=0.88\textheight]{fronts_occurrence/transparent/#1<#2>.pdf}}}%
\begin{frame}
  \frametitle{Cartes de probabilité de présence des fronts}
  \includegraphics[height=0.88\textheight]{fronts_occurrence/transparent/base<1->.pdf}%
...
\newcommand\graph[1]{%
    ...
    width=\textwidth, height=0.9\textheight, keepaspectratio
    ]{région_étude/transparent/#1.pdf}}}%
\begin{frame}
  \boxtitle{Partie 1}
...
\newcommand\graphstep[2]{%
  \llap{\includegraphics<#2>[
    width=\textwidth, height=0.8\textheight, keepaspectratio
    ]{distrib_region_perm/transparent/#1<#2>.pdf}}}%
\begin{frame}
  \frametitle{Mesure de l'impact des fronts}
  \includegraphics[
    width=\textwidth, height=0.8\textheight, keepaspectratio
  ]{distrib_region_perm/transparent/base<1->.pdf}%
...
\begingroup
\newcommand\graphstep[2]{%
  \llap{\includegraphics<#2>[height=0.8\textheight]{res_perm_exces/transparent/#1<#2>.pdf}}}%
\begin{frame}
  \frametitle{Augmentation locale de la chl-a}
  \includegraphics[height=0.8\textheight]{res_perm_exces/transparent/base<1->.pdf}%
...
\begin{frame}
  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.48\textwidth}
      ...
      \visible<3->{
        \begin{center}
          \includegraphics[height=4cm]{biais_gradient/biais_gradient.pdf}
          \\
...
\begin{frame}
  ...
  \includegraphics[width=\textwidth]{res_perm_surplus/transparent/base<1->.pdf}%
  \llap{\includegraphics<2->[width=\textwidth]{res_perm_surplus/transparent/surplus<2->.pdf}}%
...
\newcommand\graph[2]{%
  \llap{\includegraphics<#2>[
    width=\textwidth, height=0.8\textheight, keepaspectratio
    ]{zone_separation/transparent/#1<#2>.pdf}}}%
\begin{frame}
  \frametitle{Détection journalière du mur nord du Gulf Stream}
  \includegraphics[
  width=\textwidth, height=0.8\textheight, keepaspectratio
  ]{zone_separation/transparent/base<1->.pdf}%
...
\begingroup
\newcommand\graph[2]{%
  \llap{\includegraphics<#2>[width=\textwidth]{res_sais_exces/transparent/#1<#2>.pdf}}}%
\begin{frame}
  \frametitle{Impact des fronts (faibles et forts) sur la Chl-a}
  \includegraphics[width=\textwidth]{res_sais_exces/transparent/base<1->.pdf}%
  \graph{exces}{2-}%
...
\begingroup
\newcommand\graph[2]{%
  \llap{\includegraphics<#2>[width=\textwidth]{res_sais_surplus/transparent/#1<#2>.pdf}}}%
\begin{frame}
  \frametitle{Impact des fronts (faibles et forts) sur la Chl-a}
  \includegraphics[width=\textwidth]{res_sais_surplus/transparent/base<1->.pdf}%
  \graph{surplus}{2-}%
...
\newcommand\graph[2]{%
    \llap{\includegraphics<#2>[
    width=\textwidth, height=0.8\textheight, keepaspectratio
    ]{phenologie_méthode/transparent/#1<#2>.pdf}}}%
\begin{frame}
  \frametitle{Chronométrer le bloom: démarrage et durée}
  \includegraphics[
    width=\textwidth, height=0.8\textheight, keepaspectratio
  ]{phenologie_méthode/transparent/base<1->.pdf}%
  \graph{dchl_base}{4-}%
  \graph{dchl}{4}%
...
\begingroup
\newcommand\graph[2]{%
  \llap{\includegraphics<#2>[height=0.7\textheight]{bloom_démarrage/transparent/#1<#2>.pdf}}}%
\begin{frame}
  \frametitle{Décalage du \emph{\textit{démarrage}} du bloom}
  \includegraphics[height=0.7\textheight]{bloom_démarrage/transparent/base<1->.pdf}%
  \graph{blue_error}{2-}%
  \graph{cyan_error}{3-}%
...
\begin{frame}
  ...
  \includegraphics[height=0.6\textheight]{conclusion/conclusion.pdf}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item participation à
          \href{https://github.com/xarray-contrib/cf-xarray/pull/354}{{\footnotesize PyPi}:cf-xarray}
  \end{itemize}
  }

  \vfill

  \visible<3->{{\usebeamercolor[fg]{structure}\(\Rightarrow\)} Continuer à développer ces outils,\\les rendre plus pratiques pour d'autres utilisateurs}
...
\begin{frame}
  ...
  \includegraphics[
  width=\textwidth, height=0.8\textheight, keepaspectratio
  ]{annexes/separation_evol_month.pdf}
\end{frame}
...
\begin{frame}
  ...
  ]{annexes/distrib_composantes.pdf}
  \\
  pour l'année 2007
\end{frame}
...
\begin{frame}
  ...
  \includegraphics[
  width=\textwidth, height=0.7\textheight, keepaspectratio
  ]{annexes/zhai_2008_fig1.jpg}
  \\
  \datenote{Zhai et al. 2008, fig. 1}
\end{frame}
...
\begin{frame}
  ...
  \includegraphics[
  width=\textwidth, height=0.7\textheight, keepaspectratio
  ]{annexes/sarmiento_2004_fig2b.jpg}
  \\
  \datenote{Sarmiento et al. 2004, fig. 2b}
\end{frame}
